  ...
  "use strict";
	...
	jQuery(document).on('ready', function(){
		...
		if( $('#map_canvas').width() ){	
			...
			var get_lat = '50.958618';
			var get_lng = '4.349209';
			var get_add1 ='Low_res';
			var get_add2 ='Eversemsesteenweg 59, 1852 Grimbergen, Belgium';
			var get_add3 ='+32 479 48 65 32';
            var get_add4 ='Click here to get directions on Google Maps';
			...
			var desc='<div>'+
						  ...
						  '<p>'+get_add2+'</p>'+
						  '<p>'+get_add3+'</p>'+
                          '<a href="https://www.google.com/maps/place/Eversemsesteenweg+59,+1852+Meise,+Belgi%C3%AB/@50.9587501,4.3483339,17z/data=!3m1!4b1!4m2!3m1!1s0x47c3e9961f476d77:0xb4bfe650fd0bc1d0" target="_blank" class="link">'+get_add4+'</a>'+
					 '</div>';
